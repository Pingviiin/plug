...
def generate_product_scents(product_types: list, scents: list) -> list:
    ...
    """
    return [[product, scent] for product in product_types for scent in scents]
...
def check_service_availability(service_schedules: dict, date: str) -> list:
    ...
    """
    return [service for service in service_schedules if date in service_schedules.get(service)]
