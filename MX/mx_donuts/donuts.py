...
if __name__ == '__main__':
    donut1 = Donut("Chocolate Glazed Donut", 1.99, [
                   "chocolate", "sugar"], ["dairy", "nuts", "chocolate"])
    donut2 = Donut("Strawberry Sprinkle Donut", 1.49, [
                   "strawberry", "sprinkles"], ["gluten"])
    donut3 = Donut("Vanilla Cream-Filled Donut", 2.29,
                   ["vanilla", "sugar"], ["dairy"])
    donut4 = Donut("Cinnamon Sugar Donut", 1.29, [
                   "cinnamon", "sugar"], ["dairy", "gluten"])
    donut5 = Donut("Special Donut", 2.90, [
                   "sugar", "vanilla", "sprinkles", "chocolate"], ["dairy"])
    donut6 = Donut("Chocolate Donut", 1.79, [
                   "chocolate", "sprinkles"], ["nuts", "chocolate"])
